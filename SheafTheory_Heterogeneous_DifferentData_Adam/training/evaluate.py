...
def evaluate_models(
    ...
    def hook_model1(module, input, output):
           # output is shape [B,64,8,8], we flatten manually
    ...
    def hook_model2(module, input, output):
        ...
        model_2_projection_list.append(F.relu(output).detach().cpu())

    # Register the hook
    hook1 = model_1.pool2.register_forward_hook(hook_model1)
    hook2 = model_2.fc1.register_forward_hook(hook_model2)
