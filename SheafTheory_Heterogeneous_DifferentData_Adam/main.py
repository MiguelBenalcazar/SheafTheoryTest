...
def main(args):
    ...
    logger.info(f"Initializing Dataset: {"cifar10"} and {"r_mnist"}")
    ...
    P21 = torch.nn.Linear( model_2.fc2.weight.shape[1], args.latent_dim, bias=False)
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        while True:
            ...
            theta2 = model_2.fc2.weight.detach()
